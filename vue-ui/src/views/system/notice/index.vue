  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="" prop="createBy">
        <el-input v-model="queryParams.createBy" placeholder="请输入操作人员" v-hasRole="['subadmin', 'admin']" clearable
    ...
    <!-- 公告详细内容对话框 -->
    <el-dialog title="公告详细内容" :visible.sync="detailOpen" width="800px" append-to-body>
      <el-form ref="detailForm" :model="detailForm" label-width="80px">
        <el-row>
          <el-col :span="24">
            <el-form-item label="公告标题">
              <el-input v-model="detailForm.noticeTitle" :readonly="true" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="公告类型">
              <dict-tag :options="dict.type.sys_notice_type" :value="detailForm.noticeType" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="状态">
              <dict-tag :options="dict.type.sys_notice_status" :value="detailForm.status" />
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="内容">
              <div class="notice-content" v-html="detailForm.noticeContent"></div>
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
