      ...
      <el-col :span="24" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" border>
          ...
          <el-table-column label="用户昵称" align="center" key="nickName" prop="nickName" v-if="columns[2].visible"
            :show-overflow-tooltip="true" />
          <el-table-column label="学院" align="center" key="deptName" prop="dept.deptName" v-if="columns[3].visible"
            :show-overflow-tooltip="true" />
          <el-table-column label="手机号码" align="center" key="phonenumber" prop="phonenumber" v-if="columns[4].visible"
            width="200" />
          <el-table-column label="状态" align="center" width="100" key="status" v-if="columns[5].visible">
        ...
        <el-row>
          ...
          <el-col :span="12">
            ...
            <el-form-item label="归属校区" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" :show-count="true" placeholder="请选择归属校区" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
  ...
  data () {
    return {
      ...
      rules: {
        ...
        deptId: [
          { required: true, message: "归属校区不能为空", trigger: "blur" },
        ],
        nickName: [
