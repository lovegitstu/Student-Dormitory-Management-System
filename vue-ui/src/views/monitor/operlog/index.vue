  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="" prop="operName">
        <el-input v-model="queryParams.operName" placeholder="请输入操作人员" v-hasRole="['subadmin', 'admin']" clearable
    ...
    <el-table border ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange"
      ...
      <el-table-column label="消耗时间" align="center" prop="costTime" :show-overflow-tooltip="true" sortable="custom"
        :sort-orders="['descending', 'ascending']">
        <template slot-scope="scope">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button size="small" type="warning" icon="el-icon-view" @click="handleView(scope.row, scope.index)"
...
export default {
  ...
  methods: {
    /** 查询登录日志 */
    getList () {
      if (this.crruentRoles != 'admin') {
        if (this.crruentRoles != 'sysadmin') {
          this.queryParams.operName = this.crruentUser
          console.log(this.queryParams.operName)
        }
      }
      this.loading = true;
