  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="" prop="userName">
        <el-input v-model="queryParams.userName" placeholder="请输入用户名称" v-hasRole="['subadmin', 'admin']" clearable
  ...
  methods: {
    ...
    getList () {
      if (this.crruentRoles != 'admin') {
        if (this.crruentUser != 'sysadmin') {
          console.log(this.crruentUser)
          this.queryParams.userName = this.crruentUser
        }
      }
      this.loading = true;
