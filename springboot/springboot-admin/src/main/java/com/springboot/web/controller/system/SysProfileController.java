...
import com.springboot.common.utils.file.MimeTypeUtils;
import com.springboot.framework.web.service.TokenService;
...
public class SysProfileController extends BaseController
{
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception
    {
        ...
        {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(SpringbootConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
